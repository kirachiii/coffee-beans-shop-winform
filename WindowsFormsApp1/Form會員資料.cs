...
{
    public partial class Form會員資料 : Form   
    {
        string mf="";
        int identity ;
        public Form會員資料()
        ...
        private void Form會員資料_Load(object sender, EventArgs e)
        {
            // 設定 ComboBox 預設選擇項目
        ...
        void 讀取資料()
        {
            ...
            string query = "SELECT userid, user姓名, user電話, user電子郵件, user出生日期, user性別, user身分 FROM userinfo";
        ...
        private void btn修改資料_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
        ...
        private void rdo客人_CheckedChanged(object sender, EventArgs e)
        {

        }

        private void rdo員工_CheckedChanged(object sender, EventArgs e)
        {
        ...
        private void btn搜尋_Click(object sender, EventArgs e)
        {
            ...
            {
                case "會員ID":
                    query = "SELECT * FROM userinfo WHERE userid LIKE @keyword";
                    break;
                case "會員姓名":
                    query = "SELECT * FROM userinfo WHERE user姓名 LIKE @keyword";
                    break;
                case "會員電話":
                    query = "SELECT * FROM userinfo WHERE user電話 LIKE @keyword";
                    break;
                case "會員電子郵件":
                    query = "SELECT * FROM userinfo WHERE user電子郵件 LIKE @keyword";
                    break;
                default:
